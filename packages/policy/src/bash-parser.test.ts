...
describe("classifyBashCommand", () => {
	...
	describe("dangerous commands", () => {
		it.each([
			...
			["mail user@example.com", "write-irreversible"],
			["mailx -s subject user@example.com", "write-irreversible"],
			["sendmail -t", "write-irreversible"],
			["mutt -s subject user@example.com", "write-irreversible"],
			["postfix start", "write-irreversible"],
